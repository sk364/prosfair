...
from gui import gui_basic
from common.constants import WHITE, SIZE, BACKGROUND_FILE_PATH
 
pygame.init()

 
class MenuItem(pygame.font.Font):
  def __init__(self, text, font=None, font_size=48, font_color=WHITE, pos=(0, 0)):
    pos_x, pos_y = pos
          ...
          if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            for item in self.items:
              if item.is_mouse_selection(mpos):
                ...
                self.funcs[item.text](gui_basic.chessboard)
...
if __name__ == "__main__":
  ...
  funcs = {
    "Play v/s CPU" : gui_basic.looping_cpu_vs_human,
